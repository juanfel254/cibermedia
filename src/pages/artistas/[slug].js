            ...
            <div>
              <iframe
                ...
                src={
                  ...
                  getGold(artista.ACF.youtube_link)
                }
                title={artista.ACF.nombre_del_proyecto}
                frameBorder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                allowFullScreen
              ></iframe>
            </div>
            <p className={styles.visual_desc}>{artista.ACF.sinopsis_video}</p>
            <p>{artista.ACF.creditos_video}</p>
          </li>
          <li className={styles.sound_project_container}>
            {artista.ACF.archivo_audio && (
              <AudioPlayer src={artista.ACF.archivo_audio} />
            )}
            <p className={styles.sound_desc}>{artista.ACF.sinopsis_audio}</p>
            <p>{artista.ACF.creditos_audio}</p>
          </li>
        </ul>
      </div>
    </>
